...
function BRT(){
	cp /primeirosemestre/.config/teclado/keyboardbr /etc/default/
...
function ITT(){
	cp /primeirosemestre/.config/teclado/keyboardit /etc/default/
	rm -rf /etc/default/keyboard
...
function JPT(){
	cp /primeirosemestre/.config/teclado/keyboardjp /etc/default/
	rm -rf /etc/default/keyboard
...
function EST(){
	cp /primeirosemestre/.config/teclado/keyboardes /etc/default/
...
function UST(){
	cp /primeirosemestre/.config/teclado/keyboardus /etc/default/
	rm -rf /etc/default/keyboard
...
function FRT(){
	cp /primeirosemestre/.config/teclado/keyboardfr /etc/default/
	rm -rf /etc/default/keyboard
