...
function masc(){
mv /primeirosemestre/.config/ip/estaticoedhcp /primeirosemestre/.config/ip/interfaces
cp /primeirosemestre/.config/ip/interfaces /primeirosemestre/.config/ip/estaticoedhcp
echo >> /primeirosemestre/.config/ip/interfaces
echo "auto $int" >> /primeirosemestre/.config/ip/interfaces
echo "allow-hotplug $int" >> /primeirosemestre/.config/ip/interfaces
echo "iface $int inet static" >> /primeirosemestre/.config/ip/interfaces
echo "address $ip" >> /primeirosemestre/.config/ip/interfaces
echo "netmask $mask" >> /primeirosemestre/.config/ip/interfaces
mv /primeirosemestre/.config/ip/interfaces /etc/network/interfaces
service networking restart | dialog --backtitle "ROKUKISHI PROJECT" --infobox "Reiniciando interface de rede" 0 0
case $? in
...
echo >> /primeirosemestre/.config/ip/interfaces
echo "allow-hotplug $int" >> /primeirosemestre/.config/ip/interfaces
echo "iface $int inet dhcp" >> /primeirosemestre/.config/ip/interfaces
mv /primeirosemestre/.config/ip/interfaces /etc/network/interfaces
service networking restart | dialog --backtitle "ROKUKISHI PROJECT" --infobox "Reiniciando interface de rede" 0 0
case $? in
	0) dialog --backtitle "ROKUKISHI PROJECT" --ok-label Continuar --msgbox "Alterado com sucesso" 0 0; menu;;
