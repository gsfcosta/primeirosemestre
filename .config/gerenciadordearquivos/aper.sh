...
arq=$( dialog						\
	...
	10 70 )
case $? in
	1|255) bash /primeirosemestre/.config/gerenciadordearquivos/garq.sh;;
esac
...
case $arq2 in
	...
	6) p1=3; perg;;
	7) p1=7; perg;;
	*) bash /primeirosemestre/.config/gerenciadordearquivos/garq.sh;;
esac
...
case $? in
	0) dialog --backtitle "ROKUKISHI PROJECT" --ok-label Continuar --msgbox "Permissões alteradas com sucesso" 0 0; bash /primeirosemestre/.config/gerenciadordearquivos/garq.sh;;
